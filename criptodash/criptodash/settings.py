...
# Redis-based cache (shared across workers, fixes rate-limiting and whale score caching)
CACHES = {
    'default': {
...
# HSTS/SSL settings from .env (production)
...
# WebSocket channel layer (Redis for multi-worker production)
CHANNEL_LAYERS = {
    'default': {
...
CELERY_BEAT_SCHEDULE = {
    ...
    # == MAINTENANCE ==
    'cleanup-scan-results-daily': {
        'task': 'dashboard.tasks.cleanup_old_scan_results_task',
