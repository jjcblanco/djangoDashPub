...
urlpatterns = [
    ...
    path('whale-insights/search/', views.search_tokens_ajax, name='search_tokens_ajax'),
    ...
    path('whale-insights/api/live-prices/', views.whale_live_prices, name='whale_live_prices'),
    ...
    path('whale-insights/targets/<int:target_id>/toggle/', views.hunt_targets_toggle, name='hunt_targets_toggle'),
    path('whale-insights/targets/<int:target_id>/delete/', views.hunt_targets_delete, name='hunt_targets_delete'),
    path('whale-insights/api/token-stats/<int:wallet_id>/', views.whale_token_stats_ajax, name='whale_token_stats_ajax'),
    path('whale-insights/api/behavior/<int:wallet_id>/', views.whale_behavior_ajax, name='whale_behavior_ajax'),
