...
def _calculate_indicators(df):
    ...
    return {
        ...
        'macd_signal': round(macd_signal_val, 6) if macd_signal_val else None,
        'macd_hist': round(macd_hist_val, 6) if macd_hist_val else None,
        'macd_cross': 'bullish' if (macd_val and macd_signal_val and macd_val > macd_signal_val) else 'bearish',
